    ...
    <section class="list">                
        ...
        <table border="0">
            ...
            <c:forEach var="article" items="${articles}">
	            <tr>
	                ...
	                <td><a href="/Farmstory2/board/view.do?group=${group}&cate=${cate}&no=${no}&pg=${currentPage}">${article.title}[${article.comment}]</a></td>
	                <td>${article.nick}</td>
        ...
        <div class="page">
            ...
            <c:forEach var="i" begin="${pageGroupStart}" end="${pageGroupEnd}">
            	<a href="/Farmstory2/board/list.do?group=${group}&cate=${cate}&pg=${i}" class="${currentPage == i ? 'current':'off'}">${i}</a>
            </c:forEach>
